			...
			<div class="container">
				  <div class="card-deck mb-3 text-center">
					...
					<div class="card mb-4 shadow-sm">
      					<div class="card-header">
							<!-- formulario nombre -->
							<label class="my-0 font-weight-normal" data-translate="NOMBRECENTRO"></label> 
						</div>
      					<div class="card-body">
					...
					<div class="card mb-4 shadow-sm">
      					<div class="card-header">
							...
							<label class="my-0 font-weight-normal" data-translate="DIRECCIONCENTRO"></label>
						</div>
      					<div class="card-body">
					...
					<div class="card mb-4 shadow-sm">
      					<div class="card-header">
							...
							<label class="my-0 font-weight-normal" data-translate="responsable"></label>
						</div>
      					<div class="card-body">
