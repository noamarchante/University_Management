...
?>
			<!-- muestra un mensaje -->
			<h1 class="tituloFormulario"><label data-translate="Informacion centro"></label>   <img src="../View/img/centro.png" width="42" height="42"></h1>	
			<!-- saltos -->
			<br>
			<br>
			...
			<a href='../Controller/CENTRO_Controller.php?action=SEARCH'><img src="../View/Icons/buscar.png" alt="<?php echo $strings['Buscar'];?>" width="42" height="42"/></a>
...
?>
						...
						<td style="border-left:1px #dee2e6 solid">
							...
							<form style="display:inline" action="../Controller/EDIFICIO_Controller.php" method='post'>
								...
								<button class="button" style="border-left:1px #dee2e6 solid;margin-left: 1.5em" type='submit' name="action" value="SEARCH" ><img src="../View/img/edificio.png" alt="<?php echo $strings['Informacion edificio'];?>" width="42" height="42"/></button>
							</form>
