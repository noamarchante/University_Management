			...
			<form name = 'Form' action='../Controller/PROF_TITULACION_Controller.php' method='post' onsubmit="return comprobarAddProf_Titulacion()">
				...
				<div class="row justify-content-md-left">
					...
					<div class="form-group">
						<input type = 'text' name = 'dni' class="form-control input-lg" id = 'dni' data-translate="Letras y numeros" size = '9' maxlenght=9 value = '' onblur="comprobarVacio(this) && comprobarDni(this)" required><br>
					</div>
				</div>
				...
				<div class="row justify-content-md-left">
					...
					<div class="form-group">
						<input type = 'number' name = 'anhoAcademico' class="form-control input-lg" id = 'anhoAcademico' data-translate="Solo numeros" size = '9' maxlength=9 value = '' onblur="comprobarVacio(this) && comprobarEntero(this,1,999999999)" required><br>
					</div>
				</div>
