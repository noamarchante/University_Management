...
*/
	...
	class PROF_TITULACION_DELETE{//clase borrar
		...
		?>
			...
			<!-- texto -->
			<h1 class="tituloFormulario"><label data-translate="Borrar">   <img src="../View/Icons/borrar.png" width="42" height="42"></h1>	
			<!-- formulario -->
				...
				<div class="container">
					<div class="card-deck mb-3 text-center">
						...
						<div class="card mb-4 shadow-sm">
      						...
      						<div class="card-body">
								<input type = 'text' name = 'anhoAcademico' class="form-control-plaintext" id = 'anhoAcademico' size=9 value='<?php echo $this->tupla['ANHOACADEMICO']; ?>' readonly><br>
							</div>
						</div>
