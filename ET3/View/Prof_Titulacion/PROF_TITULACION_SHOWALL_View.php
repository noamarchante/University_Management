...
*/
	...
	class PROF_TITULACION_SHOWALL{//clase showall
		...
		var $datos; //definir la variable datos
...
?>
			<!-- muestra un mensaje -->
			<h1 class="tituloFormulario"><label data-translate="Informacion prof_titulacion"></label>   <img src="../View/img/profesor.png" width="42" height="42"><img src="../View/img/titulacion.png" width="42" height="42"></h1>	
			<!-- saltos -->
			<br>
			<br>
			...
			<!-- link-->
			<a href='../Controller/PROF_TITULACION_Controller.php?action=SEARCH'><img src="../View/Icons/buscar.png" alt="<?php echo $strings['Buscar'];?>" width="42" height="42"/></a>
