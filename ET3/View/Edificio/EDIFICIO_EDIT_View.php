...
<!-- ------------------------------------------------------------------------------------------------------------ -->
			...
			<form name = 'Form' action='../Controller/EDIFICIO_Controller.php' method='post' onsubmit="return comprobarAddEdificio()">
				...
				<div class="row justify-content-md-left">
					...
					<div class="form-group">
						<input type = 'text' class="form-control input-lg" name = 'nombreEdificio' maxlength=50 size=50 id = 'nombreEdificio' data-translate="Solo letras" value = '<?php echo $this->tupla['NOMBREEDIFICIO']; ?>' onblur="comprobarVacio(this) && comprobarAlfabetico(this,50)" required><br>
					</div>
				</div>
				...
				<div class="row justify-content-md-left">
					...
					<div class="form-group">
						<input type = 'text' class="form-control input-lg" name = 'direccionEdificio' maxlength=150 size=150 id = 'direccionEdificio' data-translate="Letras y numeros" value = "<?php echo $this->tupla['DIRECCIONEDIFICIO']; ?>" onblur="comprobarVacio(this) && comprobarTexto(this,150)" required><br>
					</div>
				</div>
				...
				<div class="row justify-content-md-left">
					...
					<div class="form-group">
						<input type = 'text' class="form-control input-lg" name = 'campusEdificio' maxlength=10 size=10 id = 'campusEdificio' data-translate="Solo letras" value = '<?php echo $this->tupla['CAMPUSEDIFICIO']; ?>' onblur="comprobarVacio(this) && comprobarAlfabetico(this,10)" required><br>
					</div>
				</div>
