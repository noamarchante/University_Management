			...
			<form name = 'Form' action='../Controller/EDIFICIO_Controller.php' method='post' onsubmit="return comprobarAddEdificio()">
				...
				<div class="row justify-content-md-left">
					...
					<div class="form-group">
						<input type = 'text'  class="form-control input-lg" name = 'codEdificio' id = 'codEdificio' data-translate="Letras y numeros" size = '19' maxlength=10 value = '' onblur= "comprobarVacio(this) && comprobarTexto(this,10)" required><br>
					</div>
				</div>
				...
				<div class="row justify-content-md-left">
					...
					<div class="form-group">
						<input type = 'text'  class="form-control input-lg" name = 'nombreEdificio' id = 'nombreEdificio' data-translate="Solo letras" size = '50' maxlength=50 value = '' onblur="comprobarVacio(this) && comprobarAlfabetico(this,50)" required><br>
					</div>
				</div>
				...
				<div class="row justify-content-md-left">
					...
					<div class="form-group">
						<input type = 'text'  class="form-control input-lg" name = 'direccionEdificio' id = 'direccionEdificio' data-translate="Letras y numeros" size = '150' maxlength=150 value = '' onblur="comprobarVacio(this) && comprobarTexto(this,150)" required><br>
					</div>
				</div>
				...
				<div class="row justify-content-md-left">
					...
					<div class="form-group">
						<input type = 'text'  class="form-control input-lg" name = 'campusEdificio' id = 'campusEdificio' data-translate="Solo letras" size = '10' maxlength=10 value = '' onblur="comprobarVacio(this) && comprobarAlfabetico(this,10)" required><br>
					</div>
				</div>
