...
?>
			...
			<!-- link -->
			<a href='../Controller/PROF_ESPACIO_Controller.php?action=ADD'><?php echo $strings['Añadir']; ?></a>

			<!-- salto -->
			<br>

			<!-- link-->
			<a href='../Controller/PROF_ESPACIO_Controller.php?action=SEARCH'><?php echo $strings['Buscar']; ?></a>
...
?>
			...
			<td>
				<a href='../Controller/PROF_ESPACIO_Controller.php?action=EDIT&DNI=<?php echo $fila['DNI'];?>&CODESPACIO=<?php echo $fila['CODESPACIO']; ?>'> <?php echo $strings['Editar']; ?> </a>
				</td>
				<td>
					<a href='
						../Controller/PROF_ESPACIO_Controller.php?action=DELETE&DNI=<?php echo $fila['DNI'];?>&CODESPACIO=<?php echo $fila['CODESPACIO']; ?>'><?php echo $strings['Borrar']; ?> </a>
				</td>
				<td>
					<a href='
						../Controller/PROF_ESPACIO_Controller.php?action=SHOWCURRENT&DNI=<?php echo $fila['DNI']?>&CODESPACIO=<?php echo $fila['CODESPACIO']; ?>'><?php echo $strings['Informacion detallada']; ?> </a>
				</td>
