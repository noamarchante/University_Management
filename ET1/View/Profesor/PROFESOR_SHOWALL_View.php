...
?>
			...
			<!-- link -->
			<a href='../Controller/PROFESOR_Controller.php?action=ADD'><?php echo $strings['Añadir']; ?></a>

			<!-- salto -->
			<br>

			<!-- link-->
			<a href='../Controller/PROFESOR_Controller.php?action=SEARCH'><?php echo $strings['Buscar']; ?></a>
...
?>
			...
			<td>
				<a href='../Controller/PROFESOR_Controller.php?action=EDIT&DNI=<?php echo $fila['DNI']; ?>'> <?php echo $strings['Editar']; ?> </a>
				</td>
				<td>
					<a href='
