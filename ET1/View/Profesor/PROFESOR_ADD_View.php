...
<!-- ------------------------------------------------------------------------------------------------------------ -->
			...
			<form name = 'Form' action='../Controller/PROFESOR_Controller.php' method='post'>
				...
				<!-- formulario nombre -->
				<?php echo $strings['NOMBREPROFESOR'] . ':' ?> <input type = 'text' name = 'nombre' id = 'nombre' placeholder = "<?php echo $strings['Solo letras']; ?>" size = '30' value = '' onblur="esNoVacio('nombre')  && 
				comprobarSoloLetras('nombre',30)" ><br>
				...
				<?php echo $strings['departamento'] . ':' ?> <input type = 'text' name = 'departamento' id = 'departamento' size = '40' value = '' onblur="esNoVacio('departamento') && comprobarDepartamento('departamento')" ><br> 
