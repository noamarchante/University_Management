...
?>
			...
			<!-- link -->
			<a href='../Controller/EDIFICIO_Controller.php?action=ADD'><?php echo $strings['Añadir']; ?></a>

			<!-- salto -->
			<br>

			<!-- link-->
			<a href='../Controller/EDIFICIO_Controller.php?action=SEARCH'><?php echo $strings['Buscar']; ?></a>
...
?>
			...
			<td>
				<a href='../Controller/EDIFICIO_Controller.php?action=EDIT&CODEDIFICIO=<?php echo $fila['CODEDIFICIO']; ?>'> <?php echo $strings['Editar']; ?> </a>
				</td>
				<td>
					<a href='
