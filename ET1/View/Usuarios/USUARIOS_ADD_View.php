...
<!-- ------------------------------------------------------------------------------------------------------------ -->
			...
			<form name = 'Form' action='../Controller/USUARIOS_Controller.php' method='post'>
				...
				<!-- formulario nombre -->
				<?php echo $strings['Nombre'] . ':' ?> <input type = 'text' name = 'nombre' id = 'nombre' placeholder = "<?php echo $strings['Solo letras']; ?>" size = '30' value = '' onblur="esNoVacio('nombre')  && 
				...
				<!-- formulario email -->
				<?php echo $strings['email'] . ':' ?> <input type = 'email' name = 'email' id = 'email' size = '40' value = '' onblur="esNoVacio('email') && comprobarEmail('email')" ><br>
