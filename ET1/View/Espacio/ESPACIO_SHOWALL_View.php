...
?>
			...
			<!-- link -->
			<a href='../Controller/ESPACIO_Controller.php?action=ADD'><?php echo $strings['Añadir']; ?></a>

			<!-- salto -->
			<br>

			<!-- link-->
			<a href='../Controller/ESPACIO_Controller.php?action=SEARCH'><?php echo $strings['Buscar']; ?></a>
...
?>
			...
			<td>
				<a href='../Controller/ESPACIO_Controller.php?action=EDIT&CODESPACIO=<?php echo $fila['CODESPACIO']; ?>'> <?php echo $strings['Editar']; ?> </a>
				</td>
				<td>
					<a href='
