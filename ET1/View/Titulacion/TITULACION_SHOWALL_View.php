...
?>
			...
			<!-- link -->
			<a href='../Controller/TITULACION_Controller.php?action=ADD'><?php echo $strings['Añadir']; ?></a>

			<!-- salto -->
			<br>

			<!-- link-->
			<a href='../Controller/TITULACION_Controller.php?action=SEARCH'><?php echo $strings['Buscar']; ?></a>
...
?>
			...
			<td>
				<a href='../Controller/TITULACION_Controller.php?action=EDIT&CODTITULACION=<?php echo $fila['CODTITULACION']; ?>'> <?php echo $strings['Editar']; ?> </a>
				</td>
				<td>
					<a href='../Controller/TITULACION_Controller.php?action=DELETE&CODTITULACION=
							<?php echo $fila['CODTITULACION']; ?>
							'><?php echo $strings['Borrar']; ?> </a>
				</td>
				<td>
					<a href='../Controller/TITULACION_Controller.php?action=SHOWCURRENT&CODTITULACION=
							<?php echo $fila['CODTITULACION']; ?>
