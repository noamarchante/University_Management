...
<!-- ------------------------------------------------------------------------------------------------------------ -->
			...
			<form name = 'Form' action='../Controller/TITULACION_Controller.php' method='post' onsubmit="return comprobarAddTitulacion()">
				...
				<div class="row justify-content-md-left">
					...
					<div class="form-group">
						<input type = 'text' class="form-control input-lg" name = 'nombreTitulacion' id = 'nombreTitulacion' placeholder = "<?php echo $strings['Solo letras']; ?>" size = '50' maxlength=50 value = '<?php echo $this->tupla['NOMBRETITULACION']; ?>' onblur="comprobarVacio(this) && comprobarAlfabetico(this,50)" required><br>
					</div>
				</div>
				...
				<div class="row justify-content-md-left">
					...
					<div class="form-group">
						<input type = 'text' class="form-control input-lg" name = 'responsableTitulacion' id = 'responsableTitulacion' size = '60' maxlength=60 placeholder = "<?php echo $strings['Solo letras']; ?>" value = '<?php echo $this->tupla['RESPONSABLETITULACION']; ?>' onblur="comprobarVacio(this) && comprobarAlfabetico(this,60)" required><br>
					</div>
				</div>
