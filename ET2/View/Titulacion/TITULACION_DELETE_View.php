...
*/
	...
	class TITULACION_DELETE{//clase borrar
		...
		?>
			...
			<!-- texto -->
			<h1 class="titulacionFormulario"><?php echo $strings['Borrar']; ?>   <img src="../View/Icons/borrar.png" width="42" height="42"></h1>	
					...
					<div class="card-deck mb-3 text-center">
						...
						<div class="card mb-4 shadow-sm">
							<div class="card-header">
								...
								<label class="my-0 font-weight-normal"><?php echo $strings['NOMBRETITULACION']?></label> 
							</div>
      						<div class="card-body">
						...
						<div class="card mb-4 shadow-sm">
							<div class="card-header">
								...
								<label class="my-0 font-weight-normal"><?php echo $strings['RESPONSABLETITULACION']?></label>
							</div>
      						<div class="card-body">
