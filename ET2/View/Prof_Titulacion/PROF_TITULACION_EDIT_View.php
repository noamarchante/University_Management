...
<!-- ------------------------------------------------------------------------------------------------------------ -->
			...
			<form name = 'Form' action='../Controller/PROF_TITULACION_Controller.php' method='post' onsubmit="return comprobarAddProf_Titulacion()">
				...
				<div class="row justify-content-md-left">
					...
					<div class="form-group">
						<input type = 'number' name = 'anhoAcademico' class="form-control input-lg" id = 'anhoAcademico' placeholder = "<?php echo $strings['Solo numeros']; ?>" size = '9' maxlength=9 value = '<?php echo $this->tupla['ANHOACADEMICO']; ?>' onblur="comprobarVacio(this) && comprobarEntero(this,1,999999999)"><br>
					</div>
				</div>
				<!-- salto -->
				<br>
