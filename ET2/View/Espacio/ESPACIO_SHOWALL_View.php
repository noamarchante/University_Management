...
?>
			<!-- muestra un mensaje -->
			<h1 class="tituloFormulario"><?php echo $strings['Informacion espacio']; ?>   <img src="../View/img/espacio.jpg" width="42" height="42"></h1>	
			...
			<!-- link-->
			<a href='../Controller/ESPACIO_Controller.php?action=SEARCH'> <img src="../View/Icons/buscar.jpg" width="42" height="42" alt="<?php echo $strings['Buscar']; ?>"/></a>
