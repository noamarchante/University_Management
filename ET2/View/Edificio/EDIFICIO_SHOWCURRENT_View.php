				...
				<div class="container">
				  <div class="card-deck mb-3 text-center">
					...
					<div class="card mb-4 shadow-sm">
      					<div class="card-header">
							<!-- formulario nombre -->
							<label class="my-0 font-weight-normal"><?php echo $strings['NOMBREEDIFICIO']?></label>
						</div>
      					<div class="card-body">
					...
					<div class="card mb-4 shadow-sm">
      					<div class="card-header">
							...
							<label class="my-0 font-weight-normal"><?php echo $strings['direccion']?></label>
						</div>
      					<div class="card-body">
					...
					<div class="card mb-4 shadow-sm">
      					<div class="card-header">
							<!-- formulario campus -->
							<label class="my-0 font-weight-normal"><?php echo $strings['CAMPUSEDIFICIO']?></label>
						</div>
      					<div class="card-body">
