...
<!-- ------------------------------------------------------------------------------------------------------------ -->
			...
			<form name = 'Form' action='../Controller/EDIFICIO_Controller.php' method='post'>
				...
				<div class="row justify-content-md-left">
					...
					<div class="form-group">
						<input type = 'text' class="form-control input-lg" name = 'nombreEdificio' id = 'nombreEdificio' placeholder = "<?php echo $strings['Solo letras']; ?>" size = '50' maxlength=50 onblur="comprobarAlfabetico(this,50)" value = ''><br>
					</div>
				</div>
				...
				<div class="row justify-content-md-left">
					...
					<div class="form-group">
						<input type = 'text' class="form-control input-lg" name = 'direccionEdificio' id = 'direccionEdificio' placeholder = "<?php echo $strings['Letras y numeros'];?>" size = '150' maxlength=150 onblur="comprobarTexto(this,150)" value = ''><br>
					</div>
				</div>
				...
				<div class="row justify-content-md-left">
					...
					<div class="form-group">
						<input type = 'text' class="form-control input-lg" name = 'campusEdificio' id = 'campusEdificio' placeholder = "<?php echo $strings['Letras y numeros']; ?>" size = '10' maxlength=10 onblur="comprobarTexto(this,10)" value = ''><br>
					</div>
				</div>
