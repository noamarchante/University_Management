	...
	class USUARIOS_DELETE{//clase borrar
		...
		?>
			...
			<form name = 'Form' action='../Controller/USUARIOS_Controller.php' method='post'>
				<!-- texto -->
				<h1 class="tituloFormulario"><?php echo $strings['Borrar']; ?>   <img width="42" height="42" src="../View/Icons/borrar.png"/></h1>
  				<div class="container">
					...
					<div class="card-deck mb-3 text-center">
						...
						<div class="card mb-4 shadow-sm">
      						<div class="card-header">
								...
								<label class="my-0 font-weight-normal"><?php echo $strings['Fecha de nacimiento']?> </label>
							</div>
      						<div class="card-body">
						...
						<div class="card mb-4 shadow-sm">
      						...
      						<div class="card-body">
							  <img src="<?php echo $this->tupla['fotopersonal'];?>" name='fotoPersonal' id='fotoPersonal' width="150" height="150" alt="<?php echo $strings['imagen'];?>"/>
						...
						<div class="card mb-4 shadow-sm">
     						<div class="card-header">
      						...
      						<div class="card-body">
								<input type = 'text' class="form-control-plaintext" name = 'sexo' id = 'sexo' value = '<?php if($this->tupla['sexo']=='mujer'){ echo $strings['Mujer']; }else{ echo $strings['Hombre'];} ?>' readonly><br>
							</div>
						</div>
					</div>
				</div>
