...
<!-- ------------------------------------------------------------------------------------------------------------ -->
			...
			<form name = 'Form' action='../Controller/CENTRO_Controller.php' method='post' onsubmit="return comprobarAddCentro()">
				...
				<div class="row justify-content-md-left">
					...
					<div class="form-group">
						<input type = 'text' class="form-control input-lg" name = 'nombreCentro' id = 'nombreCentro' placeholder = "<?php echo $strings['Solo letras']; ?>" size = '50' maxlength=50 value = '<?php echo $this->tupla['NOMBRECENTRO']; ?>' onblur="comprobarVacio(this) && comprobarAlfabetico(this,50)" required><br>
					</div>
				</div>
				...
				<div class="row justify-content-md-left">
					...
					<div class="form-group">
						<input type = 'text' class="form-control input-lg" name = 'direccionCentro' id = 'direccionCentro' placeholder = "<?php echo $strings['Letras y numeros']; ?>" size = '150' maxlength=150 value = "<?php echo $this->tupla['DIRECCIONCENTRO']; ?>" onblur="comprobarVacio(this) && comprobarTexto(this,150)" required><br>
					</div>
				</div>
				...
				<div class="row justify-content-md-left">
					...
					<div class="form-group">
						<input type = 'text' class="form-control input-lg" name = 'responsableCentro' id = 'responsableCentro' placeholder = "<?php echo $strings['Solo letras']; ?>" size = '60' maxlength=60 value = '<?php echo $this->tupla['RESPONSABLECENTRO']; ?>' onblur="comprobarVacio(this) && comprobarAlfabetico(this,60)" required><br>
					</div>
				</div>
