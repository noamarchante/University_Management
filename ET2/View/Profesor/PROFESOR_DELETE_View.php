				...
				<div class="container">
					<div class="card-deck mb-3 text-center">
						...
						<div class="card mb-4 shadow-sm">
      						<div class="card-header">
								<!-- formulario nombre -->
								<label class="my-0 font-weight-normal"><?php echo $strings['NOMBREPROFESOR']?></label> 
							</div>
      						<div class="card-body">
						...
						<div class="card mb-4 shadow-sm">
      						<div class="card-header">
								...
								<label class="my-0 font-weight-normal"><?php echo $strings['APELLIDOSPROFESOR']?></label>
							</div>
      						<div class="card-body">
						...
						<div class="card mb-4 shadow-sm">
      						<div class="card-header">
								<!-- formulario area -->
								<label class="my-0 font-weight-normal"><?php echo $strings['AREAPROFESOR']?></label>
							</div>
      						<div class="card-body">
						...
						<div class="card mb-4 shadow-sm">
      						<div class="card-header">
								...
								<label class="my-0 font-weight-normal"><?php echo $strings['departamento']?></label>
							</div>
      						<div class="card-body">
