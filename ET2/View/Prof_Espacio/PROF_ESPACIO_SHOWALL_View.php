...
?>
			<!-- muestra un mensaje -->
			<h1 class="tituloFormulario"><?php echo $strings['Informacion prof_espacio']; ?>   <img src="../View/img/profesor.png" width="42" height="42">  <img src="../View/img/espacio.jpg" width="42" height="42"></h1>	
			...
			<!-- link-->
			<a href='../Controller/PROF_ESPACIO_Controller.php?action=SEARCH'><img src="../View/Icons/buscar.jpg" alt="<?php echo $strings['Buscar'];?>" width="42" height="42"/></a>
